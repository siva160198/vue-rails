module Api
  module V1
    class StepUpsController < ApplicationController
      PURPOSES = %w[account_security password_change email_change recovery_codes passkey_delete sessions_revoke admin_user_create admin_user_update admin_role_change admin_approval totp_enroll totp_disable].freeze
