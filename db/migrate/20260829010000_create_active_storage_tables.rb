class CreateActiveStorageTables < ActiveRecord::Migration[8.1]
  def change
    ...
    create_table :active_storage_attachments, id: primary_key_type do |t|
      ...
      t.references :blob, null: false, type: primary_key_type, foreign_key: { to_table: :active_storage_blobs }
      t.datetime :created_at, null: false
      t.index %i[record_type record_id name blob_id], unique: true, name: :index_active_storage_attachments_uniqueness
    end

    create_table :active_storage_variant_records, id: primary_key_type do |t|
      t.belongs_to :blob, null: false, index: false, type: primary_key_type, foreign_key: { to_table: :active_storage_blobs }
